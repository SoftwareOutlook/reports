...
\begin{algorithm}[H]
  ...
  \begin{algorithmic}
    ...
    \FOR {$i=0,\ldots,N_s-1$} \STATE $transform[i]=DFT(signal[i])$
    \ENDFOR
...
\bibitem{mkl} Intel Math Kernel Library, \url{https://software.intel.com/en-us/mkl}
...
\bibitem{bibccppetmr} Collaborative Computational Project in Positron
...
\bibitem{code} Software Outlook's GitHub Repository: FFT Benchmarking
...
\bibitem{archer} ARCHER: the UK National Computing Service
